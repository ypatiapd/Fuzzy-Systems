...
%% TRAIN THE MODEL
 ...
 %2 rules
genfis_opt.ClusterInfluenceRange=0.7
...
title('input2 ');
ylabel('Membership function');
saveas(gcf,'TSK_l_input2_finalMF.png');
...
saveas(gcf,'FuzzyOutput_TSK_1.png');
...
saveas(gcf,'TrainingErrors_TSK_l.png');
