...
fis_opt.OutputMembershipFunctionType = 'linear';
...
saveas(gcf,'tsk_3_input1_initMF.png');
...
ylabel('Membership function');
saveas(gcf,'tsk_3_input2_initMF.png');
...
ylabel('Membership function');
saveas(gcf,'tsk_3_input3_initMF.png');
...
ylabel('Membership function');
saveas(gcf,'tsk_3_input4_initMF.png');
...
title('input1 - Temperature');
ylabel('Membership function');
saveas(gcf,'tsk_3_input1_finalMF.png');
...
title('input2 - Ambient pressure');
ylabel('Membership function');
saveas(gcf,'tsk_3_input2_finalMF.png');
...
title('input3 - Relative humidity');
ylabel('Membership function');
saveas(gcf,'tsk_3_input3_finalMF.png');
...
title('input4 - Exhaust vacuum');
ylabel('Membership function');
saveas(gcf,'tsk_3_input4_finalMF.png');
%% MODEL EVALUATION
...
saveas(gcf,'PredictionError3.png');
