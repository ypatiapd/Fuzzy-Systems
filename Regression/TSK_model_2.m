...
% 60% gia training, 20% gia epikirwsi kai 20% gia elegxo apodosis
...
fis_opt.NumMembershipFunctions = [3 3 3 3]; % Two mf for each input variable
...
%plotting initial fis input membership functions
figure;
...
saveas(gcf,'tsk_2_input1_initMF.png');
...
ylabel('Membership function');
saveas(gcf,'tsk_2_input2_initMF.png');
...
ylabel('Membership function');
saveas(gcf,'tsk_2_input3_initMF.png');
...
ylabel('Membership function');
saveas(gcf,'tsk_2_input4_initMF.png');
...
title('input1 - Temperature');
ylabel('Membership function');
saveas(gcf,'tsk_2_input1_finalMF.png');
...
title('input2 - Ambient pressure');
ylabel('Membership function');
saveas(gcf,'tsk_2_input2_finalMF.png');
...
title('input3 - Relative humidity');
ylabel('Membership function');
saveas(gcf,'tsk_2_input3_finalMF.png');
...
title('input4 - Exhaust vacuum');
ylabel('Membership function');
saveas(gcf,'tsk_2_input4_finalMF.png');
...
saveas(gcf,'PredictionError2.png');
...
saveas(gcf,'TrainingErrors2.png');

%mse = 0.000016 rmse = 0.004016 R2 = 0.999934 nmse = 0.059313 ndei = 0.243543
